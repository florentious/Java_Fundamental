...
public class Homework2 {
	...
	public static void main(String[] args) {
		...
		// 자기 이하의 숫자로 나눠서 나누어떨어지면 checkPrime이 false, 그리고 그 즉시 반복문 종료한다.
		// inner for문이 다돌고도 checkPrime이 true인경우 출력, 아니면 다음을 위해 checkPrime을 true
		// 만들고 종료
		...
		// 경우이기 때문이다.
		// 문제는 소수 배열의 사이즈가 어떻게 해야할지 생각해야함
		/*
		int arrayLength = 8;
